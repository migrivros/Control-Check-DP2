...
public class AdministratorAnnouncementCreateTest extends TestHarness {
		...
		@Order(10)
		public void positiveTest(final int recordIndex, final String title, final String body, final String email, final String critical, final String moreInfo, final String confirmation) {
		...
		@Order(20)
		public void negativeTest(final int recordIndex, final String title, final String body, final String email, final String critical, final String moreInfo, final String confirmation) {
